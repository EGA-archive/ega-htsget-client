 ...
 * @author jrobinso
 */
public class EgaSeekableHTTPStreamOAuth extends SeekableStream {
    ...
    public EgaSeekableHTTPStreamOAuth(final URL url) {
        this(url, null, null);
    }

    public EgaSeekableHTTPStreamOAuth(final URL url, String auth) {
        this(url, null, auth);
    }
